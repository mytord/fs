...
func (s *PrivateApiService) ListProfiles(
	ctx context.Context,
	limit, offset int32,
	filterFirstName, filterLastName string,
	...
	profiles, err := s.profileRep.FindAll(filterFirstName, filterLastName, limitInt+1, offsetInt)
